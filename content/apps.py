...
class ContentConfig(AppConfig):
    ...
    Define la configuración predeterminada para la aplicación de contenidos, incluyendo el nombre interno de la aplicación,
    el tipo de campo automático por defecto y el nombre descriptivo que se mostrará en el panel de administración.
