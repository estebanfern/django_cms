...
('Introducción a la IA', 'Un resumen sobre los fundamentos de la inteligencia artificial', 1, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week', '<p>Contenido detallado sobre IA.</p>', 'publish'),
...
('Últimos Gadgets de 2024', 'Revisión de los gadgets más innovadores del año', 1, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week', '<p>Revisión de los gadgets más innovadores de 2024.</p>', 'publish'),
('Recetas Fáciles para el Día a Día', 'Platos sencillos y rápidos para tu día a día', 2, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week', '<p>Recetas fáciles para cada día.</p>', 'publish'),
('Beneficios del Yoga', 'Cómo el yoga puede mejorar tu salud física y mental', 3, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week', '<p>Beneficios del yoga explicados.</p>', 'publish'),
...
('Destinos Exóticos para Viajar', 'Explora los destinos más exóticos del mundo', 5, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week', '<p>Guía para destinos exóticos.</p>', 'publish'),
...
('Avances en Biotecnología', 'Últimos avances y descubrimientos en biotecnología', 10, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week', '<p>Avances recientes en biotecnología.</p>', 'publish'),
...
('Tips de Fotografía para Principiantes', 'Consejos básicos para mejorar tus fotos', 4, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week', '<p>Consejos básicos de fotografía.</p>', 'publish'),
('Nutrición y Salud', 'Cómo una buena nutrición puede cambiar tu vida', 3, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NULL, '<p>Importancia de la nutrición.</p>', 'inactive'),
...
('Cocina Internacional', 'Descubre recetas de diferentes partes del mundo', 6, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week', '<p>Recetas internacionales.</p>', 'publish'),
...
('Contenido Expirado', 'Expirado', 1, 2, TRUE, NOW(), NOW() + INTERVAL '1 week', NOW() + INTERVAL '1 week', '<p>Contenido expirado.</p>', 'inactive'),
